...
if (class_exists('My_Youtube_Recommendation')) return;
...
class My_Youtube_Recommendation_Admin {
    ...
    public function add_page_footer () {
    ...
    public function channel_id_callback () {
        ...
        <input 
            type="text" 
            id="channel_id" 
            name="my_yt_rec[channel_id]" 
            value="<?php echo $value ?>" 
        />
        <p class="description">
            <?php echo __('sample' , 'my-youtube-recommendation') ?>: UCFuIUoyHB12qpYa8Jpxoxow
        </p>
        <p class="description">
            <a 
                ...
                target="_blank"
            >
                    <?php echo __('Find here your channel Id' , 'my-youtube-recommendation') ?>
            </a>
        </p>
        <?php
    }
